...
from .classification_layer import Logistic, SoftMax
from .loss_function import LossFunction
from .weights_bias import WeightsBias
from .activator_layer import Sigmoid, Tanh
...
class NeuralNet(object):
    ...
    def forward(self, batch_x):
        ...
        elif self.params.net_type == NetType.Fitting:
            self.a3 = z3
    ...
    def show_training_history(self, x):
        self.loss_trace.show_loss_history(self.params, x)
